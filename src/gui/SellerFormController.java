...
public class SellerFormController implements Initializable {
	...
	private Seller getFormData() {
		...
		ValidationException exception = new ValidationException("Validate Error Exception");
		...
		obj.setBaseSalary(Utils.tryParceToDouble(txtBaseSalary.getText()));
	...
	private void initializeNodes() {
		...
		Constrains.setTextFieldMaxLength(txtEmail, 100);
